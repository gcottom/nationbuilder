...
<body>
<div>
<p>In order to build a plantation you must meet the following requirements:<br>
Technology:${nation.getTechnology()}/100<br>
Production: ${nation.getProduction()}/250<br>
Money: ${nation.getMoney()}/1000</p>
<p>Library provides: +5 population</p>
<c:choose>
<c:when test ="${canBuild.getCanBuild()}">
<a href="buildPlantation-gc23">Click here to build plantation!</a>
</c:when>
<c:otherwise>
