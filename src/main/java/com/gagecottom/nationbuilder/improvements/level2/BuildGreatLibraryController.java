...
@Controller
public class BuildGreatLibraryController {
	@Autowired
	private UserService userService;
	@Autowired
	private NationService nationService;
	@GetMapping("/buildGreatLibrary")
	public String editResources(Model model) {
    	...
    	return "buildGreatLibrary";
	}
	
	@GetMapping ("/buildGreatLibrary-gc23")
